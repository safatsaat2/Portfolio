  ...
  return (
    <div className="border-t-2 border-bg max-w-[1280px] mx-auto rounded">
      <div className="flex justify-between items-center">
        ...
        <button className="text-xl px-3 py-1 rounded bg-word text-bg font-medium hover:text-word hover:bg-bg transition-all duration-500"><a href="../../../../public/resume (2).pdf">Download Resume</a></button>
